...
class TaskComment extends BaseNotification
{
    ...
    public function toMail($notifiable)
    {
        ...
        $heading = __('email.taskComment.subject') . ' - ' . ucfirst($this->task->heading) . ' #' . $this->task->task_short_code . '<br>';
        $projectName = ($this->task->project != null) ? '<br>'. __('app.project') . ' - ' . ucfirst($this->task->project->project_name). '<br>' : '<br>';
