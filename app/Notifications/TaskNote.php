...
class TaskNote extends BaseNotification
{
    ...
    public function toMail($notifiable)
    {
        ...
        $projectName = (!is_null($this->task->project)) ? __('app.project') . ' - ' . ucfirst($this->task->project->project_name) : '';

        $content = __('email.taskNote.subject') . ' - ' . ucfirst($this->task->heading) . ' #' . $this->task->task_short_code . '<br>' . $projectName;
    ...
    public function toOneSignal($notifiable)
    {
        return OneSignalMessage::create()
            ...
            ->setBody(ucfirst($this->task->heading) . ' ' . __('email.taskNote.subject'));
    }
