...
return array(
    ...
    'noUsersFound' => 'Seems like no employees exist. Please create the employee first',
    ...
    'newUserInfo' => 'According to date of joining.',
    ...
    'inviteInfo' => 'Users will receive an email to log in and update their profile through the self-service portal.',
    ...
    'duplicateEntryForUserId' => 'Duplicate Entry for User ID : ',
    'employeeNotFound' => 'User not found',
    ...
    'employeeShiftAdded' => 'User Shift Saved.',
    ...
    'totalUserInfo' => 'Total employees in the company. Date filter not applied.',
    ...
    'leave' => array(
        ...
        'unusedLeave' => 'Determines how the unused leaves are treated at the end of the year.<br><br><b>Carry Forward</b>: Unused leaves will be added to next year leaves.<br><br><b>Lapse</b>: Unused leaves will simply lapse and no action will be taken.<br><br><b>Paid</b>: User will be paid salary of the number of days equivalent of unused leaves.',
